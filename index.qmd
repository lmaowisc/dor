...
The median DOR can thus be estimated by $\inf\{t: \hat S_D(t)\leq 0.5\}$, whose variance can be estimated by perturbing the influence functions of $\hat S_D(t)$ using standard normal random noises.
